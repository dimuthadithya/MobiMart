<footer id="footer" class="overflow-hidden" style="color: #000; padding-top: 3rem; padding-bottom: 2rem;">
    <div class="container">
                ...
                <div class="footer-menu">
                    ...
                    <div class="social-links mt-3">
                        <ul class="d-flex list-unstyled gap-3">
                            <li>
                                <a href="#" title="Facebook" class="text-light fs-4">
                                    <svg class="facebook">
                            ...
                            <li>
                                <a href="#" title="Instagram" class="text-light fs-4">
                                    <svg class="instagram">
                            ...
                            <li>
                                <a href="#" title="Twitter" class="text-light fs-4">
                                    <svg class="twitter">
                            ...
                            <li>
                                <a href="#" title="LinkedIn" class="text-light fs-4">
                                    <svg class="linkedin">
                            ...
                            <li>
                                <a href="#" title="YouTube" class="text-light fs-4">
                                    <svg class="youtube">
        ...
        <div id="footer-bottom" class="text-center pt-2">
            <p class="mb-0 small">&copy; <?php echo date('Y'); ?> MobiMart. All Rights Reserved.</p>
        </div>
    </div>
</footer>