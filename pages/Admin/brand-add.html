                ...
                <div class="card h-50">
                    <div class="card-body">
                        <ul class="sidebar-menu">
                            ...
                            <li>
                                <a href="./brands.html" class="active">
                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="./brand.html" class="text-decoration-none text-dark">Brands</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Add New Brand</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="mt-2 mt-md-0">
                        <a href="./brands.html" class="btn btn-outline-secondary">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-6">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <button type="submit" class="btn dark-btn px-4 py-2">
